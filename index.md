...
<body onload="
  ...
  document.getElementById('qrcode').src = 
    'https://chart.googleapis.com/chart?cht=qr&chs=177x177&chl=' + location.href;
">
  <img id="qrcode" style="float:right; margin:5px; border:1px solid lightgrey; width:70px" />

  <!-- Markdown content starts here -->
  <img style="float:right;border-radius:100%;width:130px;padding:6px" src="profilepicsmall.jpg" alt="Profile Picture" />
